...
export default function Call() {
  return (
    <div id="contact" className="text-center p-8 md:p-16">
      <h1 className="md:text-4xl text-3xl font-cinzel text-white my-6 md:mb-12">
        CALL OR VISIT
      </h1>
      <div className="flex flex-col md:flex-row">
        <div className="flex flex-col text-start  font-sanspro text-white w-full md:w-1/2 gap-6 p-4 md:p-8 border-b-2 border-gray-500 md:border-none">
        ...
        <div className="flex flex-col text-center md:text-start mt-4 md:mt-0 p-10 px-12 md:px-16 font-sanspro text-white gap-2 w-full md:w-1/2">
          ...
          <div className="flex items-center justify-center">
            <a
             ...
             duration-300 hover:scale-105 hover:shadow-lg hover:bg-blue-500 hover:text-[#faf9f6] gap-2 inline-flex items-center w-fit"
            >
              <span>
